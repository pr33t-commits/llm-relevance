...
#   --nsamples $nsamples \
#   --output_path ../llm-relevance-results/llama3.1--pairwise--resid_post--layer-pos--$pos--prompt-dqi
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pairwise--mlp_out--layer-pos--$pos--prompt-dqi \
#   --overwrite
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pairwise--attn_out--layer-pos--$pos--prompt-dqi \
#   --overwrite
...
python main.py \
  ...
  --prompt_template "${prompt}" \
  --nsamples $nsamples \
  --output_path ../llm-relevance-results/llama3.1--pairwise--z--layer-pos-head--$pos--prompt-dqi \
  --overwrite
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path "results/llama3.1--pairwise--attn_scores--layer-head-dest-src--$(echo $pos | tr ' ' '-')--prompt-dqi"
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pairwise--q--layer-pos-head--$pos--prompt-dqi
