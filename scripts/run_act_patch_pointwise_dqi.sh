...
#   --nsamples $nsamples \
#   --output_path ../llm-relevance-results/llama3.1--pointwise--resid_post--layer-pos--$pos--prompt-dqi
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pointwise--mlp_out--layer-pos--$pos--prompt-dqi
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pointwise--attn_out--layer-pos--$pos--prompt-dqi
...
python main.py \
  ...
  --prompt_template "${prompt}" \
  --nsamples $nsamples \
  --output_path ../llm-relevance-results/llama3.1--pointwise--z--layer-pos-head--$pos--prompt-dqi \
  --overwrite
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path "results/llama3.1--pointwise--attn_scores--layer-head-dest-src--$(echo $pos | tr ' ' '-')--prompt-dqi"
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pointwise--q--layer-pos-head--$pos--prompt-dqi
