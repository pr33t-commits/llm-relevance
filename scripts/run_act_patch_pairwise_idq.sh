...
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pairwise--mlp_out--layer-pos--$pos--prompt-idq \
#   --overwrite
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pairwise--attn_out--layer-pos--$pos--prompt-idq \
#   --overwrite
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pairwise--z--layer-pos-head--$pos--prompt-idq \
#   --overwrite
...
python main.py \
  ...
  --prompt_template "${prompt}" \
  --nsamples $nsamples \
  --output_path "results/llama3.1--pairwise--attn_scores--layer-head-dest-src--$(echo $pos | tr ' ' '-')--prompt-idq"
...
#   --prompt_template "${prompt}" \
#   --nsamples $nsamples \
#   --output_path results/llama3.1--pairwise--q--layer-pos-head--$pos--prompt-idq
